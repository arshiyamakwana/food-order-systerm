...
const DashboardLayout = () => {
  ...
  return (
        ...
        <ul className="menu p-4 w-80 min-h-full bg-base-200 text-base-content">
          ...
          <li>
            <Link to="/dashboard" className="flex justify-start mb-3">
              ...
              <span className="badge badge-error align-middle">admin</span>
            </Link>
          </li>
          <hr />
          <li className="mt-3">
    ...
    </div> : (loading ? <Login/> : <div className="h-screen flex justify-center items-center"><Link to="/"><button className="btn bg-red text-white">Back to Home</button></Link></div>)
    }
    </div>
  );
};
