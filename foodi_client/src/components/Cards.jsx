...
const Cards = ({ item }) => {
  ...
  return (
    <div to={`/menu/${item._id}`} className="card shadow-xl relative mr-5 md:my-5 hover:scale-105 transition-all duration-300 ">
      <div
      ...
      <Link to={`/menu/${item._id}`}>
        <figure>
          <img src={item.image} alt="Shoes"  style={{height:"190px"}} />
        </figure>
      </Link>
